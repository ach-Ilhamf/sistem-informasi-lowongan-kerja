            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="telepon" maxlength="100" size="100" value="{{ $p->telepon_pk }}"><br><br>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="keahlian" maxlength="100" size="100" value="{{ $p->keahlian }}"><br><br>
                    </td>
                </tr>
                <tr>
                    <td>
...
<script language="javascript">
    function myFunction() {
        if (confirm("Klik OK, jika data yang anda masukkan sudah benar.")) {
